...
# main grades
data_main_grades <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_binary_all_weekly_down_extradrop", cov_bal, "_mice1.rds"))
print("MAIN GRADES:")
data_main_grades %>% group_by(treatment_sport) %>% count() %>% adorn_totals("row")

data_main_grades_multi <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_weekly_down_extradrop", cov_bal, "_mice1.rds"))
print("MAIN GRADES:")
data_main_grades_multi %>% group_by(treatment_sport_freq) %>% count() %>% adorn_totals("row")


# main personality
data_main_pers <- readRDS(paste0("Data/Personality/Prep_10/prep_10_dml_binary_all_weekly_down_extradrop", cov_bal, "_mice1_personality.rds"))
print("MAIN PERSONALITY:")
data_main_pers %>% group_by(treatment_sport) %>% count() %>% adorn_totals("row")

data_main_pers_multi <- readRDS(paste0("Data/Personality/Prep_10/prep_10_dml_multi_all_weekly_down_extradrop", cov_bal, "_mice1_personality.rds"))
print("MAIN PERSONALITY:")
data_main_pers_multi %>% group_by(treatment_sport_freq) %>% count() %>% adorn_totals("row")
length(unique(data_main_pers_multi$group))

# robustness checks
data_rc1_grades <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_all_down_extradrop", cov_bal, "_mice1.rds"))
print("RC1 GRADES:")
data_rc1_grades %>% group_by(treatment_sport_freq) %>% count() %>% adorn_totals("row")

data_rc2_grades <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_weekly_no_extradrop", cov_bal, "_mice1.rds"))
print("RC2 GRADES:")
data_rc2_grades %>% group_by(treatment_sport_freq) %>% count() %>% adorn_totals("row")

data_rc3_grades <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_weekly_down", cov_bal, "_mice1.rds"))
print("RC3 GRADES:")
data_rc3_grades %>% group_by(treatment_sport_freq) %>% count() %>% adorn_totals("row")

data_rc5_grades <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_all_down_extradrop", "_mice1.rds"))
print("RC5 GRADES:")
data_rc5_grades %>% group_by(treatment_sport_freq) %>% count() %>% adorn_totals("row")

data_rc6_grades <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_weekly_down_extradrop", cov_bal, "_robustcheck_mice1.rds"))
print("RC6 GRADES:")
data_rc6_grades %>% group_by(treatment_sport_freq) %>% count() %>% adorn_totals("row")



print("R1C GRADES:")
data_rc1_grades %>% group_by(treatment_sport) %>% count() %>% adorn_totals("row")data_rc1_grades <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_binary_all_all_down_extradrop", cov_bal, "_mice1.rds"))
print("R1C GRADES:")
data_rc1_grades %>% group_by(treatment_sport) %>% count() %>% adorn_totals("row")data_rc1_grades <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_binary_all_all_down_extradrop", cov_bal, "_mice1.rds"))
print("R1C GRADES:")
data_rc1_grades %>% group_by(treatment_sport) %>% count() %>% adorn_totals("row")data_rc1_grades <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_binary_all_all_down_extradrop", cov_bal, "_mice1.rds"))
...
data_rc1_grades %>% group_by(treatment_sport) %>% count() %>% adorn_totals("row")data_rc1_grades <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_binary_all_all_down_extradrop", cov_bal, "_mice1.rds"))
print("R1C GRADES:")
data_rc1_grades %>% group_by(treatment_sport) %>% count() %>% adorn_totals("row")

remove(data_main_grades)
...
data_main_mice1 <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_binary_all_weekly_down_extradrop", cov_bal, "_mice1.rds")) # 506
data_main_mice2 <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_binary_all_weekly_down_extradrop", cov_bal, "_mice2.rds")) # 506
data_main_mice3 <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_binary_all_weekly_down_extradrop", cov_bal, "_mice3.rds")) # 506
data_main_mice4 <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_binary_all_weekly_down_extradrop", cov_bal, "_mice4.rds")) # 506
data_main_mice5 <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_binary_all_weekly_down_extradrop", cov_bal, "_mice5.rds")) # 506
...
data_main_multi_mice1 <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_weekly_down_extradrop", cov_bal, "_mice1.rds")) # 510
data_main_multi_mice2 <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_weekly_down_extradrop_mice2.rds") # 510
data_main_multi_mice3 <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_weekly_down_extradrop_mice3.rds") # 510
data_main_multi_mice4 <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_weekly_down_extradrop_mice4.rds") # 510
data_main_multi_mice5 <- readRDS(paste0("Data/Grades/Prep_10/prep_10_dml_multi_all_weekly_down_extradrop_mice5.rds") # 510
...
data_1_multi_mice1 <- readRDS("Data/Grades/Prep_10/prep_10_dml_multi_all_weekly_down_extradrop_robustcheck_mice1.rds")  
...
# GRADES
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_covbal_mice1.rds")
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_covbal_mice2.rds")
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_covbal_mice3.rds")
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_covbal_mice4.rds")
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_covbal_mice5.rds")
...
print(paste("Number of endogeneous variables without interactions:",
            round(mean(
              ...
              eval(parse(text =  paste0("prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 %>%", vars_endogenous))) %>% 
                dplyr::select(-contains(":")) %>% dplyr::select(-contains("_order")) %>% colnames() %>% length(),
              eval(parse(text =  paste0("prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 %>%", vars_endogenous))) %>% 
                dplyr::select(-contains(":")) %>% dplyr::select(-contains("_order")) %>% colnames() %>% length(),
              eval(parse(text =  paste0("prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 %>%", vars_endogenous))) %>% 
                dplyr::select(-contains(":")) %>% dplyr::select(-contains("_order")) %>% colnames() %>% length(),
              eval(parse(text =  paste0("prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 %>%", vars_endogenous))) %>% 
                dplyr::select(-contains(":")) %>% dplyr::select(-contains("_order")) %>% colnames() %>% length()
            ))
            ))
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_robustcheck_mice2.rds")
ncol_mice2 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 %>%
  dplyr::select(-c(outcome_grade, treatment_sport, starts_with("outcome_grade_lag"), starts_with("treatment_sport_lag"), group))
ncol_mice2_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2)
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_robustcheck_mice3.rds")
ncol_mice3 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 %>%
  dplyr::select(-c(outcome_grade, treatment_sport, starts_with("outcome_grade_lag"), starts_with("treatment_sport_lag"), group))
ncol_mice3_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3)
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_robustcheck_mice4.rds")
ncol_mice4 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 %>%
  dplyr::select(-c(outcome_grade, treatment_sport, starts_with("outcome_grade_lag"), starts_with("treatment_sport_lag"), group))
ncol_mice4_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4)
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_robustcheck_mice5.rds")
ncol_mice5 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 %>%
  dplyr::select(-c(outcome_grade, treatment_sport, starts_with("outcome_grade_lag"), starts_with("treatment_sport_lag"), group))
ncol_mice5_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5)
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_no_extradrop_covbal_mice1.rds")
ncol_mice1 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1 %>%
  dplyr::select(-c(outcome_grade, treatment_sport, starts_with("outcome_grade_lag"), starts_with("treatment_sport_lag"), group))
ncol_mice1_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1)
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_no_extradrop_covbal_mice2.rds")
ncol_mice2 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 %>%
  dplyr::select(-c(outcome_grade, treatment_sport, starts_with("outcome_grade_lag"), starts_with("treatment_sport_lag"), group))
ncol_mice2_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2)
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_no_extradrop_covbal_mice3.rds")
ncol_mice3 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 %>%
  dplyr::select(-c(outcome_grade, treatment_sport, starts_with("outcome_grade_lag"), starts_with("treatment_sport_lag"), group))
ncol_mice3_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3)
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_no_extradrop_covbal_mice4.rds")
ncol_mice4 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 %>%
  dplyr::select(-c(outcome_grade, treatment_sport, starts_with("outcome_grade_lag"), starts_with("treatment_sport_lag"), group))
ncol_mice4_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4)
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 <- readRDS("Data/Grades/Prep_10/prep_10_dml_binary_allintpoly_weekly_no_extradrop_covbal_mice5.rds")
ncol_mice5 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 %>%
  dplyr::select(-c(outcome_grade, treatment_sport, starts_with("outcome_grade_lag"), starts_with("treatment_sport_lag"), group))
ncol_mice5_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5)
...
# PERSONALITY
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1 <- readRDS("Data/Personality/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_covbal_mice1.rds")
ncol_mice1 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1 %>%
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 <- readRDS("Data/Personality/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_covbal_mice2.rds")
ncol_mice2 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2 %>%
  dplyr::select(-c(bigfive_neuroticism, treatment_sport, starts_with("treatment_sport_lag"), group))
ncol_mice2_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice2) 
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 <- readRDS("Data/Personality/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_covbal_mice3.rds")
ncol_mice3 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3 %>%
  dplyr::select(-c(bigfive_neuroticism, treatment_sport, starts_with("treatment_sport_lag"), group))
ncol_mice3_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice3)
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 <- readRDS("Data/Personality/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_covbal_mice4.rds")
ncol_mice4 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4 %>%
  dplyr::select(-c(bigfive_neuroticism, treatment_sport, starts_with("treatment_sport_lag"), group))
ncol_mice4_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice4) 
...
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 <- readRDS("Data/Personality/Prep_10/prep_10_dml_binary_allintpoly_weekly_down_extradrop_covbal_mice5.rds")
ncol_mice5 <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5)
prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 <- prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5 %>%
  dplyr::select(-c(bigfive_neuroticism, treatment_sport, starts_with("treatment_sport_lag"), group))
ncol_mice5_all <- ncol(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice5) 
...
print(paste("Total number of observations:", nrow(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1)))
print(paste("Total number of students:", length(unique(prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1))))
print(paste("Number of sport participants:", prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1 %>% filter(treatment_sport == 1) %>% nrow()))
print(paste("Number of non sport participants:", prep_10_dml_binary_allintpoly_weekly_down_extradrop_mice1 %>% filter(treatment_sport == 0) %>% nrow()))
print(paste("Total number of variables:", round(mean(c(ncol_mice1, ncol_mice2, ncol_mice3, ncol_mice4, ncol_mice5)))))
print(paste("Total number of control variables:", round(mean(c(ncol_mice1_all, ncol_mice2_all, ncol_mice3_all, ncol_mice4_all, ncol_mice5_all)))))
print(paste("Total number of interaction effects:", round(mean(c(ncol_mice1_int, ncol_mice2_int, ncol_mice3_int, ncol_mice4_int, ncol_mice5_int)))))
print(paste("Total number of polynominals:", round(mean(c(ncol_mice1_polys, ncol_mice2_polys, ncol_mice3_polys, ncol_mice4_polys, ncol_mice5_polys)))))
