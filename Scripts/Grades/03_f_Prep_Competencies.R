...
# Moreover, different competence measures are assessed across waves.
#++++
# 1.) Drop respondents:
...
if (cohort_prep == "controls_same_outcome") {
  ...
  data_comp_save <- paste0("Data/Grades/Prep_3/prep_3_competencies_robustcheck_", cohort_prep, ".rds")
}
