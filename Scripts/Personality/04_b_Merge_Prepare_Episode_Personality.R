...
if (cohort_prep == "controls_same_outcome") {
  data_cati_cawi <- readRDS(paste0("Data/Personality/Prep_4/prep_4_merge_cati_cawi_treat", 
...
# save data frame
if (cohort_prep == "controls_same_outcome") {
  data_cati_cawi_eps_save <- paste0("Data/Personality/Prep_4/prep_4_merge_cati_cawi_eps_treat", 
                                    treatment_repl, "_personality.rds") 
} else if (cohort_prep == "controls_bef_outcome") {
  data_cati_cawi_eps_save <- paste0("Data/Personality/Prep_4/prep_4_merge_cati_cawi_eps_treat", 
                                    treatment_repl, "_personality_robustcheck.rds")  
