#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
#### Sample and Variable Selection for Personality as Outcome ####
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
...
if (cohort_prep == "controls_same_outcome") {
  data_load <- paste0("Data/Personality/Prep_5/prep_5_treatment_outcome_", treatment_def, 
...
if (id_num_start == 0) {
  ...
  if (cohort_prep == "controls_same_outcome") {
    data_save <- paste0("Data/Personality/Prep_6/prep_6_sample_selection_", treatment_def, 
