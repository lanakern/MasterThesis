...
# child data
data_child <- readRDS("Data/Personality/Prep_1/prep_1_child_personality.rds") 
...
# save data frame
if (cohort_prep == "controls_same_outcome") {
  data_child_save <- "Data/Personality/Prep_3/prep_3_child_personality.rds"
} else if (cohort_prep == "controls_bef_outcome") {
  data_child_save <- "Data/Personality/Prep_3/prep_3_child_personality_robustcheck.rds"
}
