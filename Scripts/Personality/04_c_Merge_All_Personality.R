...
if (cohort_prep == "controls_same_outcome") {
  data_cati_cawi_eps <- readRDS(paste0("Data/Personality/Prep_4/prep_4_merge_cati_cawi_eps_treat", 
...
if (cohort_prep == "controls_same_outcome") {
  data_child <- readRDS("Data/Personality/Prep_3/prep_3_child_personality.rds")
} else if (cohort_prep == "controls_bef_outcome") {
  data_child <- readRDS("Data/Personality/Prep_3/prep_3_child_personality_robustcheck.rds")
}


# partner information (time-variant)
if (cohort_prep == "controls_same_outcome") {
  data_partner <- readRDS("Data/Personality/Prep_3/prep_3_partner_personality.rds")
} else if (cohort_prep == "controls_bef_outcome") {
  data_partner <- readRDS("Data/Personality/Prep_3/prep_3_partner_personality_robustcheck.rds")
}


# competencies
if (cohort_prep == "controls_same_outcome") {
  data_competencies <- readRDS("Data/Personality/Prep_3/prep_3_competencies_personality.rds")
} else if (cohort_prep == "controls_bef_outcome") {
  data_competencies <- readRDS("Data/Personality/Prep_3/prep_3_competencies_personality_robustcheck.rds")
}
...
# save
if (cohort_prep == "controls_same_outcome") {
  data_merge_all_save <- paste0("Data/Personality/Prep_4/prep_4_merge_all_treat", treatment_repl, "_personality.rds")  
} else {
  data_merge_all_save <- paste0("Data/Personality/Prep_4/prep_4_merge_all_treat", treatment_repl, "_personality_robustcheck.rds") 
}
