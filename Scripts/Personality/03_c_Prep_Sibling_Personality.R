...
data_sibling <- readRDS("Data/Personality/Prep_1/prep_1_sibling_personality.rds")
...
if (cohort_prep == "controls_same_outcome") {
  data_sibling_save <- "Data/Personality/Prep_3/prep_3_sibling_personality.rds"
} else if (cohort_prep == "controls_bef_outcome") {
  data_sibling_save <- "Data/Personality/Prep_3/prep_3_sibling_personality_robustcheck.rds"
}
