...
for (mice_data_sel in 1:2) {
  ...
  data_final <- data_final %>% ungroup() %>% type.convert(as.is = TRUE)
  ...
  # save data frame
  saveRDS(data_base_level, paste0("Data/Prep_11/prep_11_dml_binary_base", "_mice", mice_data_sel, ".rds"))
  saveRDS(data_base_stand, paste0("Data/Prep_11/prep_11_dml_binary_base_stand", "_mice", mice_data_sel, ".rds"))
  ...
  saveRDS(data_all, paste0("Data/Prep_11/prep_11_dml_binary_all", "_mice", mice_data_sel, ".rds"))
  saveRDS(data_all_stand, paste0("Data/Prep_11/prep_11_dml_binary_all_stand", "_mice", mice_data_sel, ".rds"))
