...
# by Lana Kern
#+++
# In this file, the DML results for the binary and multivalued treatment
# setting are confirmed by using the dmlmt function from Michael Knaus.
# Note that the DoubleML Function from Chernozhukov does not allow to use
# a multivalued treatment variable. However, the function from Knaus does not
# support cross-fitting. 
# Results are confirmed for GPA as outcome and all ML algorithms.
# NOTE: FUNCTION IS NOT WORKING FOR MULTIVALUED TREATMENT SETTING; BUT RESULTS
# FOR BINARY ALSO COINCIDE!
#+++
# For interpretation:
# -> T0: Daily + Weekly
# -> T1: Monthly or less
